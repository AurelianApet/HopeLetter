            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">신청 리스트</strong>
                        <div class="float-right">
                            <a href="{{ route('request.download-csv') }}" class="btn btn-outline-primary btn-sm" target="_blank">
                                <i class="fa fa-download"></i>&nbsp; CSV 다운로드
                            </a>
                        </div>
                    </div>
